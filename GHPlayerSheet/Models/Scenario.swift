...
struct Scenario {
    ...
    private static func generateScenarios() -> [Scenario] {
        ...
        let scenario18 = Scenario(number: "18", name: "Abandoned Sewers", requirements: "None", goal: "Kill all enemies")
        ...
        let scenario27 = Scenario(number: "27", name: "Ruinous Rift", requirements: "Artifact: Lost INCOMPLETE (Global) and Stonebreaker's Censer (Party) COMPLETE", goal: "Protect Hail (a) for ten rounds")
        ...
        let scenario74 = Scenario(number: "74", name: "Merchant Ship", requirements: "High Sea Escort (Party) COMPLETE", goal: "Kill all enemies and keep the ship afloat")
